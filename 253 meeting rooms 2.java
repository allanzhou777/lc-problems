class Solution {
    public int meeting(int[] intervals) {
        // create a stack with a monotonically increasing stack size
        //  if the next meeting overlaps w earliest end time, don't remove the first item
        //  if otherwise the next meeting doesn't overlap, remove first item
